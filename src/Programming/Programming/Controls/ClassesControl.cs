...
namespace Programming.Controls
{
    public partial class ClassesControl : UserControl
    {
        ...
        /// <summary>
        /// Отображает значения полей объекта Rectangle в текстбоксах.
        /// </summary>
        ...
        /// <summary>
        /// Вносит значение из LenghtTextBox в поле Height объекта Rectangle.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Вносит значение из WidthTextBox в поле Width объекта Rectangle.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Отображает значения полей объекта Film в текстбоксах.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Вносит значение из NameTextBox в поле Name объекта Film.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Вносит значение из DurationTextBox в поле DurationInMinutes объекта Film.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DurationTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (_currentFilm != null)
                {
                    ...
                    DurationTextBox.BackColor = AppColors.ValidationTrueColor;
                }
            }
            catch (FormatException)
            {
                DurationTextBox.BackColor = AppColors.ValidationFalseColor;
            }
            catch (ArgumentOutOfRangeException)
            {
        ...
        /// <summary>
        /// Вносит значение из IssueTextBox в поле YearOfIssue объекта Film.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Вносит значение из GenreTextBox в поле Genre объекта Film.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void RatingTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (_currentFilm != null)
                {
                    ...
                    RatingTextBox.BackColor = AppColors.ValidationTrueColor;
                }
            }
            catch (FormatException)
            {
                RatingTextBox.BackColor = AppColors.ValidationFalseColor;
            }
            catch (ArgumentOutOfRangeException)
            {
                RatingTextBox.BackColor = AppColors.ValidationFalseColor;
        ...
        /// <summary>
        /// Осуществляет поиск прямоугольника с максимальной шириной при нажатии на кнопку FindButton.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Осуществляет поиск фильма с максимальным рейтингом при нажатии на кнопку FindButton.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
